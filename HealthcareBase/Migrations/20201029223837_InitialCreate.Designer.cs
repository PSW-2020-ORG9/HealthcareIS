...
namespace HealthcareBase.Migrations
{
    ...
    [Migration("20201029223837_InitialCreate")]
            ...
            modelBuilder.Entity("Model.Medication.MedicationPrescription", b =>
                {
                    ...
                    b.Property<string>("DiagnosisIcd")
                    ...
                    b.Property<int?>("PrescribedByEmployeeID")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("DiagnosisIcd");
                    ...
                    b.HasIndex("PrescribedByEmployeeID");
            ...
            modelBuilder.Entity("Model.Users.UserFeedback.PatientSurveyResponse", b =>
                {
                    ...
                    b.Property<int?>("BestDoctorEmployeeID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BestDoctorEmployeeID");
            ...
            modelBuilder.Entity("Model.Requests.ScheduleProcedure", b =>
                {
                    ...
                    b.Property<int?>("PatientMedicalRecordID")
                        .HasColumnName("ScheduleProcedure_PatientMedicalRecordID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Schedule.Procedures.Surgery", b =>
                {
                    ...
                    b.Property<string>("DiagnosisIcd")
                        .HasColumnName("Surgery_DiagnosisIcd")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Model.Medication.MedicationPrescription", b =>
                {
                    ...
                    b.HasOne("Model.Users.Employee.Doctor", "PrescribedBy")
                        .WithMany()
                        .HasForeignKey("PrescribedByEmployeeID");
                                    ...
                                    b2.OwnsMany("Model.Users.Patient.MedicalHistory.FamilyMemberDiagnosis", "Diagnoses", b3 =>
                                        {
                                            ...
                                            b3.Property<string>("DiagnosisIcd")
                                                .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Model.Users.UserFeedback.PatientSurveyResponse", b =>
                {
                    b.HasOne("Model.Users.Employee.Doctor", "BestDoctor")
                        .WithMany()
                        .HasForeignKey("BestDoctorEmployeeID");
                    ...
                    b.OwnsOne("Model.Schedule.SchedulingPreferences.ProcedureSchedulingPreference", "Preference", b1 =>
                        {
                            ...
                            b1.Property<int?>("PreferredDoctorEmployeeID")
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("PreferredDoctorEmployeeID");
                            ...
                            b1.HasOne("Model.Users.Employee.Doctor", "PreferredDoctor")
                                .WithMany()
                                .HasForeignKey("PreferredDoctorEmployeeID");
